...
const Zona = () => {
  ...
  const [zones, setZones] = useState([
    { id: 1, empresaId: 1, name: 'Zona Norte', status: 'active' },
    { id: 2, empresaId: 1, name: 'Zona Sur', status: 'active' },
    { id: 3, empresaId: 2, name: 'Zona Centro', status: 'active' },
    { id: 4, empresaId: 2, name: 'Zona Este', status: 'inactive' },
  ]);
            ...
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              ...
              {filteredZones.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">No hay zonas que coincidan con "{searchTerm}"</p>
                </div>
              )}
            </div>
          </Card>
